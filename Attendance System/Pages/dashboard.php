...
<head>
  ...
  <link rel="stylesheet" href="../Attendance System/style/nav-bar.css">
...
<body>
  ...
  <aside class="sidebar-menu">
    <ul class="main-btns">
      <li>
        <a href="#"><img src="images/dashboardIcon.png" alt="" height="20"> Dashboard</a>
      </li>
    </ul>
    <div class="work-btns">
      <h3>
      ...
      <ul>
        ...
        <li>
          <a href="schedule.html"><img src="images/scheduleIcon.png" alt="" height="25">
            <div>Schedule</div>
          </a>
        </li>
      </ul>
        ...
        <div class="calendar-section">
            ...
            <div class="tardy-titans">
                ...
                <ul class="tardy-titans-list">
                    <li style="width: 100%;">
                        <img src="" alt="Profile">
                        Peter Magnus <h5 style="text-align: end; width: 50%;">5</h5>
                    </li>
                    <li>
                        <img src="" alt="Profile">
                        Matt Axel Beltran <h5 style="text-align: end; width: 50%;">5</h5>
                    </li>
                    <li>
                        <img src="" alt="Profile">
                        John Lore Maticolous <h5 style="text-align: end; width: 50%;">5</h5>
                    </li>
                    <li>
                        <img src="" alt="Profile">
                        Danny Pogi <h5 style="text-align: end; width: 50%;">5</h5>
                    </li>
                    <li>
                        <img src="" alt="Profile">
                        Pheinz Magnus <h5 style="text-align: end; width: 50%;">5</h5>
                    </li>
                </ul>
            </div>
        </div>
